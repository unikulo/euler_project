...
fn main() {
    ...
    println!("002: sum of all the even numbers in the fibonacci sequence whose values do not exceed 4 million = {0}", problem002::sum_of_multiples_of_fibonacci_sequence(2, 4000000));
    println!("003: largest prime factor of the number 600851475143 = {0}", problem003::largest_prime_factor(600851475143));
    ...
    println!("007: the 10001th prime number = {}", problem007::nth_prime_number(10001));
